<x-app-layout>
    ...
    <x-slot name="header">
        <ol class="breadcrumb page-breadcrumb">
            ...
            <li class="breadcrumb-item active">@lang('messages.groups')</li>
            <li class="position-absolute pos-top pos-right d-none d-sm-block">@livewire('js-get-date')</li>
        </ol>
        <div class="subheader">
            <h1 class="subheader-title">
                <i class="fal fa-users-class"></i> {{ __('messages.groups') }}
            </h1>
        </div>
    </x-slot>
    <div class="row">
    ...
    <script defer>
            $(document).ready(function(){
                $('#dt-basic-example').dataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('support_administration_groups_list') }}",
                    columns: [
                        {
                            id: "accions",
                            data: null,
                        ...
                        { className: "align-middle",id: "area_description",data:'area_description',name:'sup_service_areas.description'},
                        { className: "align-middle",id: "group_description",data:'group_description',name:'sup_service_area_groups.description'},
                        {
                    ...
                    buttons: [
                        {
                            ...
                            action:function(){
                                window.location.href = "{{ route('support_administration_groups_create') }}";
                            }
                        },
                        {
                            extend: 'excelHtml5',
