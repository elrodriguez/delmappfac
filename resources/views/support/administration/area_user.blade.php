<x-app-layout>
    ...
    <x-slot name="header">
        <ol class="breadcrumb page-breadcrumb">
            ...
            <li class="breadcrumb-item active">@lang('messages.areas_and_user')</li>
            <li class="position-absolute pos-top pos-right d-none d-sm-block">@livewire('js-get-date')</li>
        </ol>
        <div class="subheader">
            <h1 class="subheader-title">
                <i class="fal fa-user-headset"></i> {{ __('messages.areas_and_user') }}
            </h1>
        </div>
    </x-slot>
    <div class="row">
    ...
    <script defer>
            $(document).ready(function(){
                $('#dt-basic-example').dataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('support_administration_area_users_list') }}",
                    columns: [
                        {
                            id: "accions",
                            data: null,
                        ...
                        { className: "align-middle",id: "name",data:'name',name:'users.name'},
                        { className: "align-middle",id: "email",data:'email',name:'users.email'},
                        { className: "align-middle",id: "description",data:'description',name:'sup_service_areas.description' }
                    ],
                    ...
                    buttons: [
                        {
                            ...
                            action:function(){
                                window.location.href = "{{ route('support_administration_area_user_create') }}";
                            }
                        },
                        {
                            extend: 'excelHtml5',
