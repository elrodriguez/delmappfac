<x-app-layout>
    ...
    <x-slot name="header">
        <ol class="breadcrumb page-breadcrumb">
            ...
            <li class="breadcrumb-item active">@lang('messages.ticket_attended_by_user')</li>
            <li class="position-absolute pos-top pos-right d-none d-sm-block">@livewire('js-get-date')</li>
        </ol>
        <div class="subheader">
            <h1 class="subheader-title">
                <i class="fal fa-user-headset"></i> {{ __('messages.ticket_attended_by_user') }}
            </h1>
        </div>
    </x-slot>
    <div class="row">
        <div class="col-12">
            @livewire('support.reports.ticket-attended-user')
        </div>
    </div>
