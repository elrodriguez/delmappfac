<x-app-layout>
    ...
    <x-slot name="header">
        <ol class="breadcrumb page-breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('support_helpdesk_my_tickets_attended') }}">@lang('messages.ticket_attended')</a></li>
            <li class="breadcrumb-item active">@lang('messages.see')</li>
    ...
    @livewire('support.helpdesk.my-tickets-attended-see', ['ticket_id' => $id])
