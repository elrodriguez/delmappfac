<x-app-layout>
    ...
    <x-slot name="header">
        <ol class="breadcrumb page-breadcrumb">
            ...
            <li class="breadcrumb-item active">@lang('messages.inventory_locations')</li>
            <li class="position-absolute pos-top pos-right d-none d-sm-block">@livewire('js-get-date')</li>
        </ol>
        <div class="subheader">
            <h1 class="subheader-title">
                <i class="fal fa-map-marker-alt"></i> {{ __('messages.inventory_locations') }}
            </h1>
        </div>
    </x-slot>
    <div class="row">
    ...
    <script defer>
            $(document).ready(function(){
                $('#dt-basic-example').dataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('logistics_warehouse_inventory_locations_list') }}",
                    columns: [
                        {
                            id: "accions",
                            data: null,
                        ...
                        { className: "align-middle",id: "name",data:'name',name:'establishments.name' },
                        { className: "align-middle",id: "description",data:'description',name:'warehouses.description' },
                    ],
                    ...
                    buttons: [
                        ...
                        //     action:function(){
                        //         window.location.href = "{{ route('logistics_warehouse_inventory_locations_create') }}";
                        //     }
                        // },
                        {
                            extend: 'excelHtml5',
