<x-app-layout>
    ...
    <x-slot name="header">
        <ol class="breadcrumb page-breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('logistics_warehouse_inventory_locations') }}">@lang('messages.inventory_locations')</a></li>
            <li class="breadcrumb-item active">@lang('messages.new')</li>
            <li class="position-absolute pos-top pos-right d-none d-sm-block">@livewire('js-get-date')</li>
        </ol>
        <div class="subheader">
            <h1 class="subheader-title">
                <i class="fal fa-map-marker-alt"></i> @lang('messages.warehouse')
            </h1>
        </div>
    </x-slot>
    <div class="row">
        <div class="col-xl-12">
            <div id="panel-1" class="panel">
                ...
                @livewire('logistics.warehouse.warehouses-create-form')
            </div>
        </div>
    </div>
    @section('script')
