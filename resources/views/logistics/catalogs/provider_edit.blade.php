<x-app-layout>
    ...
    <x-slot name="header">
        <ol class="breadcrumb page-breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('logistics_catalogs_providers') }}">@lang('messages.providers')</a></li>
            <li class="breadcrumb-item active">@lang('messages.edit')</li>
            <li class="position-absolute pos-top pos-right d-none d-sm-block">@livewire('js-get-date')</li>
        </ol>
        <div class="subheader">
            <h1 class="subheader-title">
                <i class='fal fa-info-circle'></i> @lang('messages.edit') @lang('messages.provider')
            </h1>
        </div>
    </x-slot>
    <div class="row">
        <div class="col-xl-12">
            <div id="panel-1" class="panel">
                ...
                @livewire('logistics.catalogs.providers-edit-form',['provider_id'=>$id])
            </div>
        </div>
    </div>
    @section('script')
