<x-app-layout>
    ...
    <x-slot name="header">
        <ol class="breadcrumb page-breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('establishments_series',['id'=>$id]) }}">@lang('messages.series')</a></li>
            <li class="breadcrumb-item active">@lang('messages.edit')</li>
            <li class="position-absolute pos-top pos-right d-none d-sm-block">@livewire('js-get-date')</li>
        </ol>
        <div class="subheader">
            <h1 class="subheader-title">
                <i class='fal fa-qrcode'></i> @lang('messages.serie')
            </h1>
        </div>
    </x-slot>
    <div class="row">
        <div class="col-xl-12">
            <div id="panel-1" class="panel">
                ...
                @livewire('master.establishment-series-edit-form',['establisment_id'=>$id,'serie_id'=>$serie_id])
