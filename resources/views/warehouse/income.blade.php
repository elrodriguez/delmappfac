<x-app-layout>
    ...
    <x-slot name="header">
        <ol class="breadcrumb page-breadcrumb">
            ...
            <li class="breadcrumb-item active">@lang('messages.income')</li>
            <li class="breadcrumb-item active">@lang('messages.containers')</li>
            <li class="position-absolute pos-top pos-right d-none d-sm-block">@livewire('js-get-date')</li>
        </ol>
        <div class="subheader">
            <h1 class="subheader-title">
                <i class='fal fa-info-circle'></i> @lang('messages.income')
            </h1>
        </div>
    </x-slot>
    <div class="row">
                        ...
                        <table id="dt-basic-example" class="table table-bordered table-hover table-striped w-100">
                            <thead class="bg-primary-600">
                                <tr>
                                    ...
                                    <th width="15%" class="text-center">@lang('messages.f_issuance')</th>
                                    <th width="15%" class="text-center">@lang('messages.number')</th>
                                    <th width="60%">@lang('messages.provider')</th>
                                </tr>
                            </thead>
                        </table>
                    </div>
                    ...
                    buttons: [
                        {
                            ...
                            action:function(){
                                window.location.href = "{{ route('income_create') }}";
                            }
                        },
                        {
                            extend: 'excelHtml5',
