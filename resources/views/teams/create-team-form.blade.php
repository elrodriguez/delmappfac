                ...
                <div class="panel-content">
                    <div class="d-flex flex-row pb-3 pt-2  border-top-0 border-left-0 border-right-0">
                        <div class="d-inline-block align-middle status status-success mr-3">
                            <span class="profile-image rounded-circle d-block" style="background-image:url('{{ $this->user->profile_photo_url }}'); background-size: cover;" alt="{{ $this->user->name }}"></span>
                        </div>
                        <h5 class="mb-0 flex-1 text-dark fw-500">
                            {{ $this->user->name }}
                            <small class="m-0 l-h-n">{{ $this->user->email }}</small>
                        </h5>
                    ...
                    <div class="form-group">
                        ...
                        <input id="name" class="form-control" wire:model.defer="state.name" autofocus />
