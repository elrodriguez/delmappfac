<x-app-layout>
    ...
    <x-slot name="header">
        <ol class="breadcrumb page-breadcrumb">
            ...
            <li class="breadcrumb-item active">@lang('messages.school_enrollment')</li>
            <li class="position-absolute pos-top pos-right d-none d-sm-block">@livewire('js-get-date')</li>
        </ol>
        <div class="subheader">
            <h1 class="subheader-title">
                <i class="fal fa-line-columns"></i> {{ __('messages.school_enrollment') }}
            </h1>
        </div>
    </x-slot>
    <div class="row">
        <div class="col-xl-12">
            <div id="panel-1" class="panel">
                <div class="panel-hdr">
                    <h2>{{ __('messages.school_enrollment') }}</h2>
    ...
    <script defer>
        ...
        $(document).ready(function(){
            $('#dt-basic-example').dataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ route('enrollment_cadastre_list') }}",
                columns: [
                    {
                        id: "accions",
                        data: null,
                    ...
                    },
                    {
                        ...
                        className: "text-left",
                        render: function(data){
                            var buttons = `<ul class="list-unstyled">
                                                <li>`+data.level_description+`
                                                    <ul>
                                                        <li>`+data.year_description+`-`+data.section_description+`</li>
                                                        <li><span class="badge border border-info text-info">`+data.situation_description+`</span></li>
                                                        </ul>
                                                </li>
                                            </ul>`;
                            return buttons;
