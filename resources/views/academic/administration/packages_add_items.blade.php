<x-app-layout>
    ...
    <x-slot name="header">
        <ol class="breadcrumb page-breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="{{ route('academic_packages') }}">@lang('messages.package_commitments_promotions')</a></li>
            <li class="breadcrumb-item active">@lang('messages.add_items')</li>
            <li class="position-absolute pos-top pos-right d-none d-sm-block">@livewire('js-get-date')</li>
        </ol>
        <div class="subheader">
            <h1 class="subheader-title">
                <i class="fal fa-book"></i> @lang('messages.add_items')
            </h1>
        </div>
    </x-slot>
    <div class="row">
        <div class="col-xl-12">
            <div id="panel-1" class="panel">
                ...
                @livewire('academic.administration.packages-add-items-form',['package_id'=>$id])
            </div>
        </div>
    </div>
    @section('script')
