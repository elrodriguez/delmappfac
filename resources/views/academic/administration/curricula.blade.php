<x-app-layout>
    ...
    <x-slot name="header">
        <ol class="breadcrumb page-breadcrumb">
            ...
            <li class="breadcrumb-item active">@lang('messages.curriculas')</li>
            <li class="position-absolute pos-top pos-right d-none d-sm-block">@livewire('js-get-date')</li>
        </ol>
        <div class="subheader">
            <h1 class="subheader-title">
                <i class="fal fa-atlas"></i> {{ __('messages.curriculas') }}
            </h1>
        </div>
    </x-slot>
    <div class="row">
    ...
    <script defer>
            $(document).ready(function()
            {
                ...
                $('#dt-basic-example').dataTable(
                {
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('academic_curriculas_list') }}",
                    columns: [
                        {
                            id: "accions",
                            data: null,
                    ...
                    buttons: [
                        {
                            ...
                            action:function(){
                                window.location.href = "{{ route('academic_curricula_create') }}";
                            }
                        },
                        {
                            extend: 'excelHtml5',
