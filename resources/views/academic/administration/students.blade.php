<x-app-layout>
    ...
    <x-slot name="header">
        <ol class="breadcrumb page-breadcrumb">
            ...
            <li class="breadcrumb-item active">@lang('messages.students')</li>
            <li class="position-absolute pos-top pos-right d-none d-sm-block">@livewire('js-get-date')</li>
        </ol>
        <div class="subheader">
            <h1 class="subheader-title">
                <i class="fal fa-user-graduate"></i> {{ __('messages.students') }}
            </h1>
        </div>
    </x-slot>
    <div class="row">
    ...
    <script defer>
            $(document).ready(function(){
                $('#dt-basic-example').dataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('academic_students_list') }}",
                    columns: [
                        {
                            id: "accions",
                            data: null,
                            ...
                            render: function(data){
                                var buttons = `<div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu" style="">
                                                            ...
                                                            <a class="dropdown-item" href="`+ data.representative_url +`"><i class="fal fa-user-friends mr-1"></i>{{ __('messages.representative') }}</a>
                    ...
                    buttons: [
                        {
                            ...
                            action:function(){
                                window.location.href = "{{ route('academic_importar_alumnos_excel') }}";
                            }
                        },
                        {
                            ...
                            action:function(){
                                window.location.href = "{{ route('academic_students_create') }}";
                            }
                        },
                        {
                            extend: 'excelHtml5',
