<x-app-layout>
    ...
    <x-slot name="header">
        <ol class="breadcrumb page-breadcrumb">
            ...
            <li class="breadcrumb-item active">@lang('messages.package_commitments_promotions')</li>
            <li class="position-absolute pos-top pos-right d-none d-sm-block">@livewire('js-get-date')</li>
        </ol>
        <div class="subheader">
            <h1 class="subheader-title">
                <i class="fal fa-cubes"></i> {{ __('messages.package_commitments_promotions') }}
            </h1>
        </div>
    </x-slot>
    <div class="row">
    ...
    <script defer>
            $(document).ready(function()
            {
                ...
                $('#dt-basic-example').dataTable(
                {
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('academic_packages_list') }}",
                    columns: [
                        {
                            id: "accions",
                            data: null,
                            ...
                            render: function(data){
                                var buttons = `<div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu" style="">
                                                            ...
                                                            <a class="dropdown-item" href="`+ data.add_items_url +`"><i class="fal fa-box-usd mr-1"></i>{{ __('messages.add_items') }}</a>
                    ...
                    buttons: [
                        {
                            ...
                            action:function(){
                                window.location.href = "{{ route('academic_packages_create') }}";
                            }
                        },
                        {
                            extend: 'excelHtml5',
