<x-app-layout>
    ...
    <x-slot name="header">
        <ol class="breadcrumb page-breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="{{ route('academic_students') }}">@lang('messages.courses')</a></li>
            <li class="breadcrumb-item active">@lang('messages.edit')</li>
            <li class="position-absolute pos-top pos-right d-none d-sm-block">@livewire('js-get-date')</li>
        </ol>
        <div class="subheader">
            <h1 class="subheader-title">
                <i class="fal fa-user-graduate"></i> @lang('messages.edit') @lang('messages.course')
            </h1>
        </div>
    </x-slot>
    <div class="row">
        <div class="col-xl-12">
            <div id="panel-1" class="panel">
                ...
                @livewire('academic.administration.student-edit-form',['student_id'=>$id])
            </div>
        </div>
    </div>
    @section('script')
