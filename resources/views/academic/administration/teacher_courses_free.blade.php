<x-app-layout>
    ...
    <x-slot name="header">
        <ol class="breadcrumb page-breadcrumb">
            ...
            <li class="breadcrumb-item active">@lang('messages.reinforcement_training_courses')</li>
            <li class="position-absolute pos-top pos-right d-none d-sm-block">@livewire('js-get-date')</li>
        </ol>
        <div class="subheader">
            <h1 class="subheader-title">
                <i class="fal fa-book"></i> @lang('messages.reinforcement_training_courses')
            </h1>
        </div>
    </x-slot>
    <div class="row">
        <div class="col-xl-12">
            <div id="panel-1" class="panel">
                <div class="panel-hdr">
                    <h2>@lang('messages.reinforcement_training_courses')</h2>
                ...
                @livewire('academic.administration.teacher-assign-courses-free-form',['teacher_id'=>$id])
            </div>
        </div>
    </div>
    @section('script')
