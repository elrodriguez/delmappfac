    ...
    <x-slot name="header">
        ...
        <div class="subheader">
            <h1 class="subheader-title">
                <i class="fal fa-book"></i> {{ __('messages.courses') }}
            </h1>
        </div>
    </x-slot>
    <div class="row">
    ...
    <script defer>
            $(document).ready(function()
            {
                ...
                $('#dt-basic-example').dataTable(
                {
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('academic_courses_list') }}",
                    columns: [
                        {
                            id: "accions",
                            data: null,
                            ...
                            render: function(data){
                                ...
                                if(!data.academic_level_id && !data.academic_year_id){
                                    btn = `<a class="dropdown-item" href="`+ data.academic_charges_url +`"><i class="fal fa-folder-open mr-1"></i>Año, grado y seccion</a>`;
                                }
                                ...
                                var buttons = `<div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu" style="">
                                                            ...
                                                            `+btn+`
                                                            <a class="dropdown-item text-danger" href="javascript:void(0)" onclick="ondelete('`+data.delete_url+`')"><i class="fal fa-trash-alt mr-1"></i>Eliminar</a>
                                                        </div>
                                                    </div>`;
                                return buttons;
                            }
                        },
                        { className: "align-middle",id: "academic_level_description",data:'academic_level_description',name:'academic_levels.description' },
                        { className: "align-middle",id: "academic_year_description",data:'academic_year_description',name:'academic_years.description' },
                        //{ className: "align-middle",id: "academic_section_description",data:'academic_section_description',name:'academic_sections.description' },
                        { className: "align-middle",id: "course_description",data:'course_description',name:'courses.description' },
                        {
                    ...
                    buttons: [
                        {
                            ...
                            action:function(){
                                window.location.href = "{{ route('academic_courses_create') }}";
                            }
                        },
                        {
                            extend: 'excelHtml5',
