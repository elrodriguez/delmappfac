<x-app-layout>
    ...
    <x-slot name="header">
        <ol class="breadcrumb page-breadcrumb">
            ...
            <li class="breadcrumb-item active">@lang('messages.seasons')</li>
            <li class="position-absolute pos-top pos-right d-none d-sm-block">@livewire('js-get-date')</li>
        </ol>
        <div class="subheader">
            <h1 class="subheader-title">
                <i class="fal fa-business-time"></i> {{ __('messages.seasons') }}
            </h1>
        </div>
    </x-slot>
    <div class="row">
    ...
    <script defer>
            $(document).ready(function()
            {
                ...
                $('#dt-basic-example').dataTable(
                {
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('academic_seasons_list') }}",
                    columns: [
                        {
                            id: "accions",
                            data: null,
                        ...
                        { className: "align-middle text-center",data:'id',name:'id' },
                    ...
                    buttons: [
                        {
                            ...
                            action:function(){
                                window.location.href = "{{ route('academic_seasons_create') }}";
                            }
                        },
                        {
                            extend: 'excelHtml5',
