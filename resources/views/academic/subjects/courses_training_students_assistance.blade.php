    ...
    <x-slot name="header">
        ...
        <div class="subheader">
            <h1 class="subheader-title">
                <i class="subheader-icon fal fa-ballot-check"></i>@lang('messages.assistance')
            </h1>
        </div>
    </x-slot>
    <div class="row">
        <div class="col-xl-12">
            @livewire('academic.subjects.courses-training-students-assistance')
        </div>
    </div>
    @section('script')
    <script src="{{ url('theme/js/notifications/sweetalert2/sweetalert2.bundle.js') }}" defer></script>
    <script src="{{ url('theme/js/formplugins/bootstrap-datepicker/bootstrap-datepicker.js') }}"></script>
    <script defer>
