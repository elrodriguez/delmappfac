<x-app-layout>
    ...
    <x-slot name="header">
        <ol class="breadcrumb page-breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('subjects_courses_topic_forum_edit',[$course,$topic,$activity]) }}">@lang('messages.forum')</a></li>
    ...
    <div class="row">
        <div class="col-xl-12">
            @livewire('academic.subjects.activity-forum-comment-edit', ['course'=>$course,'topic'=>$topic,'activity'=>$activity,'comment_id' => $comment])
        </div>
    </div>
    @section('script')
