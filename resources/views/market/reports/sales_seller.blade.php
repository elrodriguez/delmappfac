<x-app-layout>
    ...
    <x-slot name="header">
        <ol class="breadcrumb page-breadcrumb">
            ...
            <li class="breadcrumb-item active">@lang('messages.sales_by_seller')</li>
            <li class="position-absolute pos-top pos-right d-none d-sm-block">@livewire('js-get-date')</li>
        </ol>
        <div class="subheader">
            <h1 class="subheader-title">
                <i class="fal fa-poll-people"></i> {{ __('messages.sales_by_seller') }}
            </h1>
        </div>
    </x-slot>
    <div class="row">
        <div class="col-12">
            @livewire('market.reports.sales-seller')
        </div>
    </div>
