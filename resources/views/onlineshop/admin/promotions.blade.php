<x-app-layout>
    ...
    <x-slot name="header">
        <ol class="breadcrumb page-breadcrumb">
            ...
            <li class="breadcrumb-item active">@lang('messages.promotions')</li>
            <li class="position-absolute pos-top pos-right d-none d-sm-block">@livewire('js-get-date')</li>
        </ol>
        <div class="subheader">
            <h1 class="subheader-title">
                <i class="fal fa-gifts"></i> {{ __('messages.promotions') }}
            </h1>
        </div>
    </x-slot>
    <div class="row">
                        ...
                        <table id="dt-basic-example" class="table table-bordered table-hover table-striped w-100">
                            <thead class="bg-primary-600">
                                <tr>
                                    ...
                                    <th>{{ __('messages.shop_carousel_title') }}</th>
    ...
    <script defer>
            $(document).ready(function(){
                $('#dt-basic-example').dataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('onlineshop_administration_promotions_list') }}",
                    columns: [
                        {
                            id: "accions",
                            data: null,
                            ...
                            render: function(data){
                                var buttons = `<div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu" style="">
                                                            ...
                                                            <a class="dropdown-item" href="`+ data.add_items_url +`"><i class="fal fa-box-full mr-1"></i>{{ __('messages.add_items') }}</a>
                        ...
                        { className: "align-middle",id: "title",data:'title',name:'title' },
                        { className: "align-middle",id: "description",data:'description',name:'description' },
                        { className: "align-middle text-right",id: "total_price",data:'total_price',name:'total_price' },
                        {
                            className: "align-middle text-center",
                            id: "state",
                            data:'state',
                    ...
                    buttons: [
                        {
                            ...
                            action:function(){
                                window.location.href = "{{ route('onlineshop_administration_promotions_create') }}";
                            }
                        },
                        {
                            extend: 'excelHtml5',
