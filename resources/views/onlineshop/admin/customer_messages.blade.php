<x-app-layout>
    ...
    <x-slot name="header">
        <ol class="breadcrumb page-breadcrumb">
            ...
            <li class="breadcrumb-item active">@lang('messages.customer_messages')</li>
            <li class="position-absolute pos-top pos-right d-none d-sm-block">@livewire('js-get-date')</li>
        </ol>
        <div class="subheader">
            <h1 class="subheader-title">
                <i class="fal fa-envelope"></i> {{ __('messages.customer_messages') }}
            </h1>
        </div>
    </x-slot>
    <div class="row">
                ...
                <div class="panel-container show">
                    <div class="panel-content">
                        ...
                        <div class="d-flex flex-grow-1 p-0">
                            ...
                            <!-- end left slider -->
                            <!-- inbox container -->
                            @livewire('onlineshop.admin.customer-messages')
                            <!-- end inbox container -->
                            <!-- compose message -->
