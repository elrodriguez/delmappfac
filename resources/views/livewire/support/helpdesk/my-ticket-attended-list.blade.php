<div>
    <div class="input-group input-group-lg mb-g">
        <input wire:model.defer="search" wire:keydown.enter="searchTicket" type="text" class="form-control shadow-inset-2" placeholder="{{ __('messages.search_ticket_by_code') }}">
            ...
            @foreach ($tickets as $ticket)
                <div class="card">
                    ...
                    <div class="card-footer text-center">
                        <button wire:click="seeDetails({{ $ticket->id }})" type="button" class="btn btn-sm btn-outline-dark waves-effect waves-themed">{{ __('messages.see') }}
                    ...
                    @foreach ($tickets as $ticket)
                        <tr>
                            <td class="text-center align-middle">
                                <a wire:click="seeDetails({{ $ticket->id }})" href="javascript:void(0);" class="btn btn-primary btn-icon rounded-circle waves-effect waves-themed" data-toggle="tooltip" data-placement="right" title="{{ __('messages.see') }}" data-original-title="{{ __('messages.attend') }}">
