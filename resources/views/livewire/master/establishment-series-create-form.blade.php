<div class="panel-container show">
    <div class="panel-content">
        <form>
            <div class="row">
                ...
                <div class="col-4">
                    <div class="form-group">
                        <label class="form-label" for="simpleinput">{{ __('messages.serie') }}</label>
                        <input name="serie" wire:model.defer="serie" type="text" id="simpleinput" class="form-control">
                        @error('serie')
                            <div class="invalid-feedback-2">{{ $message }}</div>
                        @enderror
                    </div>
    ...
    <script>
        window.addEventListener('response_series_store', event => {
