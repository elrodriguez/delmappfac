        ...
        <form class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">@lang('messages.new') @lang('messages.parameter')</h5>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <select wire:model="id_type" class="form-control" id="example-select" wire:change="changeType()">
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input type="text" wire:model="id_parameter" class="form-control" id="parameter">
                            </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" wire:loading.attr="disabled" wire:click="store()">@lang('messages.save')</button>
                </div>
            </div>
        </form>
    </div>
