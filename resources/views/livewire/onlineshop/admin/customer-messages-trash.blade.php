    ...
    <div class="flex-grow-0">
        ...
        <div class="d-flex flex-wrap align-items-center pl-3 pr-1 py-2 px-sm-4 px-lg-5 border-faded border-top-0 border-left-0 border-right-0">
            <div class="flex-1 d-flex align-items-center">
                ...
                <button wire:click="restoreMessage" class="btn btn-icon rounded-circle mr-1" data-toggle="tooltip" data-placement="right" data-original-title="{{ __('messages.restore_message') }}">
                    <i class="fas fa-trash-restore-alt fs-md"></i>
                </button>
                <button wire:click="deleteMessage" class="btn btn-icon rounded-circle mr-1" data-toggle="tooltip" data-placement="right" data-original-title="{{ __('messages.permanently_delete') }}">
                    ...
                    <li class="{{ $message->status == 'rg' ? 'unread' : '' }}">
                        <div class="d-flex align-items-center px-3 px-sm-4 px-lg-5 py-1 py-lg-0 height-4 height-mobile-auto">
                            ...
                            <div class="d-flex flex-row flex-wrap flex-1 align-items-stretch align-self-stretch order-2 order-lg-3">
                                <div class="row w-100">
                                    <a href="javascript:void(0);" class="name d-flex width-sm align-items-center pt-1 pb-0 py-lg-1 col-12 col-lg-auto">{{ $message->name }}</a>
                                    <a href="javascript:void(0);" class="name d-flex align-items-center pt-0 pb-1 py-lg-1 flex-1 col-12 col-lg-auto">{{ $message->subject }}</a>
                                </div>
                            </div>
