    ...
    <div class="flex-grow-0">
        ...
        <div class="d-flex flex-wrap align-items-center pl-3 pr-1 py-2 px-sm-4 px-lg-5 border-faded border-top-0 border-left-0 border-right-0">
            <div class="flex-1 d-flex align-items-center">
                ...
                <button wire:click="deleteMessage" id="js-delete-selected" class="btn btn-icon rounded-circle mr-1" data-toggle="tooltip" data-placement="right" data-original-title="{{ __('messages.delete') }}">
                ...
                <ul class="notification notification-layout-2">
                    ...
                    <li class="{{ $message->status == 'rg' ? 'unread' : '' }}">
                        <div class="d-flex align-items-center px-3 px-sm-4 px-lg-5 py-1 py-lg-0 height-4 height-mobile-auto">
                            <div class="custom-control custom-checkbox mr-3 order-1"> </i>
                                <input type="checkbox" class="custom-control-input msg-delete" id="msg-{{ $k }}" wire:model="items.{{ $k }}" id="msg-{{ $k }}" value="{{ $message->id }}">
