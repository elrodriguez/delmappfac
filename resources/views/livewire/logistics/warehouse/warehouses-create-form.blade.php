<div class="panel-container show">
        ...
        <div class="panel-content">
            <div class="form-row">
                <div class="col-md-6 mb-3">
                    ...
                    <select wire:model.defer="establishment_id" name="establishment_id" id="establishment_id" class="custom-select form-control">
    ...
    <script>
        window.addEventListener('response_warehouse_store', event => {
