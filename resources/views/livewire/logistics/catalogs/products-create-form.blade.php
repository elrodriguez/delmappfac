<div class="panel-container show">
    <form  class="needs-validation {{ ($errors->any()?'was-validated':'') }}" novalidate wire:ignore.self>
        <div class="panel-content">
            <div class="form-row">
                ...
                <div class="col-md-2 mb-3">
                    ...
                    <input class="form-control" id="stock" name="stock" required="" wire:model.defer="stock">
                    @error('stock')
                        <div class="invalid-feedback-2">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <span class="fal fa-image mr-1"></span> Upload
                    </span>
                    </label>
                    <div>
                        @error('file_image')
        ...
        <div class="panel-content border-faded border-left-0 border-right-0 border-bottom-0 d-flex flex-row align-items-center">
            ...
            <button wire:loading.attr="disabled" type="button" class="btn btn-primary ml-auto waves-effect waves-themed" wire:click="store">
