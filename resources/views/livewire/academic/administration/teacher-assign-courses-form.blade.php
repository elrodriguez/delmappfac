        ...
        <div class="panel-content">
            <div class="form-row">
                <div class="col-md-3 mb-3">
                    ...
                    <select class="custom-select form-control" id="level_id" name="level_id" required="" wire:model.defer="level_id" wire:change="listCourses()">
                ...
                <div class="col-md-2 mb-3">
                    ...
                    <select class="custom-select form-control" id="section_id" name="section_id" required="" wire:model.defer="section_id" wire:change="listCourses()">
                        <option>{{ __('messages.to_select') }}</option>
                    ...
                    <tbody>
                        @if(count($assignments)>0)
                            ...
                            <tr>
                                ...
                                <td class="text-center">{{ $assignment->academic_section_description }}</td>
