        ...
        <div class="panel-content">
            ...
            <div class="form-row">
                <div class="col-md-3 mb-3">
                    <div class="form-group">
                        <label class="form-label">{{ __('messages.academic_level') }} <span class="text-danger">*</span></label>
                ...
                <div class="col-md-3 mb-3">
                    <div class="form-group">
                        <label class="form-label">{{ __('messages.academic_year') }} <span class="text-danger">*</span></label>
                ...
                <div class="col-md-3 mb-3">
                    <div class="form-group">
                        <label class="form-label">{{ __('messages.academic_section') }} <span class="text-danger">*</span></label>
                ...
                <div class="col-md-3 mb-3">
                    <div class="form-group">
                        <label class="form-label">{{ __('messages.situation') }} <span class="text-danger">*</span></label>
                        <select wire:model="situation_id" name="situation_id" id="situation_id" class="custom-select form-control">
                            <option>{{ __('messages.to_select') }}</option>
            ...
            <div class="form-row">
                ...
                <div class="col-md-3 mb-3">
                    ...
                    <div class="input-group" wire:ignore>
                        <input required="" type="text" class="form-control date_register" wire:model="date_register" onchange="this.dispatchEvent(new InputEvent('input'))">
                        <div class="input-group-append">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="hidden" class="form-control" wire:model="representative_id" name="representative_id" id="representative_id">
            ...
            <div class="form-row">
                <div class="col-md-12 mb-3">
                    ...
                    <textarea class="form-control" name="observation" id="observation" wire:model="observation"></textarea>
                </div>
            </div>
        </div>
