    ...
    <div id="panel-1" class="panel">
        ...
        <div class="panel-container show">
            ...
            <div class="panel-content border-faded border-left-0 border-right-0 border-bottom-0 d-flex flex-row align-items-center">
                <a href="{{ route('subjects_student_mycourse_themes_forum',[$cu,$mt,$code]) }}" type="button" class="btn btn-secondary waves-effect waves-themed"><i class="fal fa-long-arrow-left mr-1"></i>@lang('messages.back')</a>
