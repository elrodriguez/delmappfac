<div>
    <div class="card mb-g border shadow-0">
        ...
        <div class="card-footer d-flex flex-row align-items-center">
            <button onclick="storeComment()" class="btn btn-primary ml-auto">
        ...
        <div class="card mb-g">
			<div class="card-body pb-0 px-4">
				...
				<div class="d-flex align-items-center demo-h-spacing py-3">
                    ...
                    @if($user_editor->user_id == auth()->user()->id && $comment->heart == false)
					...
					<a href="{{ route('subjects_courses_topic_class_activity_comment_edit',[$course,$topic,$activity,$comment->id]) }}" class="d-inline-flex align-items-center text-dark">
