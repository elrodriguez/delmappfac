<x-app-layout>
    ...
    <x-slot name="header">
        <ol class="breadcrumb page-breadcrumb">
            ...
            <li class="breadcrumb-item active">@lang('messages.employees')</li>
    ...
    <script defer>
            $(document).ready(function()
            {
                ...
                $('#dt-basic-example').dataTable(
                {
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('rrhh_administration_employees_list') }}",
                    columns: [
                        {
                            id: "accions",
                            data: null,
                    ...
                    buttons: [
                        {
                            ...
                            action:function(){
                                window.location.href = "{{ route('rrhh_administration_employees_import_excel') }}";
                            }
                        },
                        {
                            ...
                            action:function(){
                                window.location.href = "{{ route('rrhh_administration_employees_create') }}";
                            }
                        },
                        {
                            extend: 'excelHtml5',
