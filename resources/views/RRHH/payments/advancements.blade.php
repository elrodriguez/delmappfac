<x-app-layout>
    ...
    <x-slot name="header">
        <ol class="breadcrumb page-breadcrumb">
            ...
            <li class="breadcrumb-item active">@lang('messages.employee_concepts')</li>
            <li class="position-absolute pos-top pos-right d-none d-sm-block">@livewire('js-get-date')</li>
        </ol>
        <div class="subheader">
            <h1 class="subheader-title">
                <i class="fal fa-money-bill-wave"></i> @lang('messages.employee_concepts')
            </h1>
        </div>
    </x-slot>
    <div class="row">
    ...
    <script defer>
            $(document).ready(function()
            {
                ...
                $('#dt-basic-example').dataTable(
                {
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('rrhh_payments_advancements_list') }}",
                    columns: [
                        {
                            id: "accions",
                            data: null,
                        ...
                        },
                        {
                            ...
                            id: "observations",
                            data:'observations',
                            name: 'employee_concepts.observations'
                        },
                        {
                            className: "text-center align-middle",
                            id: "created_at",
                            data:'created_at',
                            name: 'employee_concepts.created_at'
                        },
                        {
                            className: "text-center align-middle",
                            id: "payment_date",
                            data:'payment_date',
                            name: 'employee_concepts.payment_date'
                        },
                        {
                            className: "text-right align-middle",
                            id: "amount",
                            data:'amount',
                            name: 'employee_concepts.amount'
                        },
                        {
                            id: "state",
                            data:'state',
                            ...
                            render: function(data){
                                let span;
                                if(data == 1){
                                    span = `<span class="badge badge-warning">{{ __('messages.paid') }}</span>`;
                                }else{
                                    span = `<span class="badge badge-danger">{{ __('messages.pending') }}</span>`;
                                }
                                return span;
                            }
                        }
                    ...
                    buttons: [
                        {
                            ...
                            action:function(){
                                window.location.href = "{{ route('rrhh_payments_advancements_create') }}";
                            }
                        },
                        {
                            extend: 'excelHtml5',
