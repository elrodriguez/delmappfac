...
namespace App\CoreBilling\Services\Dni;

use App\CoreBilling\Services\Helpers\CaptchaCodes;
use App\CoreBilling\Services\Helpers\Http\ClientInterface;
use App\CoreBilling\Services\Helpers\Http\ContextClient;
use App\CoreBilling\Services\Models\Person;
...
class Reniec
{
    ...
    {
        if (strlen($dni) !== 8) {
            $this->error = 'Dni debe tener 8 d�gitos';
