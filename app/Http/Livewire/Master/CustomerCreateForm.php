...
class CustomerCreateForm extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.master.customer-create-form');
    }
    ...
    public function store(){
        ...
        Customer::create(['person_id'=>$this->person_id]);

        $this->resetInput();
        $this->dispatchBrowserEvent('response_customers_store', ['message' => Lang::get('messages.successfully_registered')]);
    }
    ...
    private function searchPersonSunat(){
        ...
        $data = (array) $person->getDataRuc($this->number);
