...
class StudentCreateForm extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.academic.administration.student-create-form');
    }
    ...
    public function store(){
        ...
        Student::create([
            'student_code' => codeStudents($this->person_id),
            'country_id' => $this->country_id,
            'department_id' => $dp,
            'province_id' => $pv,
            'district_id' => $ds,
    ...
    private function searchPersonDataBase(){
        ...
        if($this->person){
            $student = Student::where('id_person',$this->person->id)->first();
