...
class TicketApplicantList extends Component
{
    use WithPagination;
    ...
    {
        return view('livewire.support.helpdesk.ticket-applicant-list',['tickets'=>$this->tickets()]);
    }
    ...
    public function tracing($id){
        return redirect()->route('support_helpdesk_ticket_applicant_tracing',$id);
    }
}
